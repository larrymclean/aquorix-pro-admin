/*
  ...
  Description:
  Phase 9 embeddable scheduler widget. Renders a destination-local dive
  schedule from legacy JSON, allows itinerary building, maintains
  available vs waitlist separation, and prepares encoded payload handoff
  to checkout.
